...
public class Story {
	...
	Story() {
		start_story = new Situation(
				"перва€ сделка (Windows)",
				"“олько вы начали работать и тут-же удача! ¬ы нашли клиента и продаете ему "
						+ "партию ѕќ ћ— ¬индовс. ≈му в принципе достаточно вз€ть 100 коробок версии HOME.\n"
		...
		start_story.direction[0] = new Situation(
				"корпоратив",
				"Ќеудачное начало, ну чтож, сегодн€ в конторе копроратив! "
						+ "ѕознакомлюсь с коллегами, людей так сказать посмотрю, себ€ покажу",
				0, 0, -10, -10);
		start_story.direction[1] = new Situation(
				"совещание, босс доволен",
				"—егодн€ будет совещание, мен€ неожиданно вызвали,"
						+ "есть сведени€ что \n босс доволен сегодн€шней сделкой.",
				0, 1, 100, 0);
		start_story.direction[2] = new Situation(
				"мой первый ло€льный клиент",
				"ћой первый клиент доворлен скоростью и качеством "
						+ "моей работы. —ейчас мне звонил лично \nдиреткор компании и сообщил что скоро состоитс€ еще более крупна€ сделка"
						+ " и он хотел чтобы по нейт работал именно €!", 0, 0,
				50, 1);
	...
	public void go(int num) {
		if (num <= current_situation.direction.length)
			...
			System.out.println("¬ы можете выьирать из "
